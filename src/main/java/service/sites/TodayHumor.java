...
@Data
public class TodayHumor implements SiteParser{
    String originalUrl = "http://mlbpark.donga.com/";
    String articleListPath = "body > div.whole_box > div > div > table > tbody > tr > td.subject";
    String titlePath = "head > meta[property=og:title]";
    String thumbnailPath = "div.viewContent img";
    String secondaryThumbnailPath = "div.viewContent img";
    String descPath = "head > meta[property=og:description]";
    Site site;

    public TodayHumor(Site site){
        this.site = site;
    }
    ...
    public List<String> getArticleList(){
        ...
        for(Element element : elementList){
            String url = "http://www.todayhumor.co.kr"+element.select("a").attr("href");
            articleList.add(url);
        }
        return articleList;
    }
